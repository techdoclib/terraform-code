...
module "aws-eks-cluster-oidc" {
  source = "../modules/terraform-aws-eks-oidc"
  cluster_name = module.aws-eks-cluster.out_aws_eks_cluster_name
  url = module.aws-eks-cluster.out_url
}